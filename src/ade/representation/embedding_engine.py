...
class EmbeddingEngine:
    ...
    feature_names = [
        ...
        "red_histogram_bin_2",
        "red_histogram_bin_3",
        "green_histogram_bin_0",
        "green_histogram_bin_1",
        "green_histogram_bin_2",
        "green_histogram_bin_3",
        "blue_histogram_bin_0",
        "blue_histogram_bin_1",
        "blue_histogram_bin_2",
        "blue_histogram_bin_3",
        "brightness_histogram_bin_0",
        "brightness_histogram_bin_1",
        "brightness_histogram_bin_2",
        "brightness_histogram_bin_3",
        "brightness_histogram_bin_4",
        "brightness_histogram_bin_5",
    ]
