...
Each run writes a Markdown report, structured JSON report, patch preview assets when enabled, one run metadata JSON file, and an updated run history index.
